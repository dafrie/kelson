...
func TestDiagnoseRendersTheServersCauses(t *testing.T) {
	...
	mustContain(t, out,
		...
		"image  Deployment/web container web  ghcr.io/acme/hello:1.4.2 → ghcr.io/acme/hello:1.4.3",
		"env    Deployment/web container web  DATABASE_URL removed (was postgres://db/app)",
		"could not be read:",
