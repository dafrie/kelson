...
| [0009](0009-secrets.md) | Secrets are references; values never enter Git | Accepted (forge-credential boundary amended by 0033) |
...
| [0026](0026-agent-audit-trail.md) | The audit trail — one principal-typed record per mutation, in a bounded cluster ring | Accepted (principal types amended by 0036) |
