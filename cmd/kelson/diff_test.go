...
// rendering (issue #46).
func rootWithEngine(factory func() (diffRunner, error)) *cobra.Command {
	root := newRootCmd()
...
func runEngineKelson(t *testing.T, factory func() (diffRunner, error), args ...string) (stdout, stderr string, code int, msg string) {
	t.Helper()
...
func TestDiffRenderWorksWithoutCluster(t *testing.T) {
	...
	stdout, _, code, _ := runEngineKelson(t, func() (diffRunner, error) {
...
func previewEngine(verdict *diff.Diff, err error) func() (diffRunner, error) {
	return func() (diffRunner, error) {
